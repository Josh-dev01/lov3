const {
  ...
  const ownerNumber = ['2637384403205']
...
const port = process.env.PORT || 9090;
  ...
  console.log('BOYKA-XD CONNECTED SUCCESSFULLY ✅')
  
  let up = `*ʙᴏʏᴋᴀ xᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ!*
*╭─「 \`𝘽𝙊𝙔𝙆𝘼 𝙓𝘿\` 」*
*│• ᴛʏᴘᴇ  .ᴍᴇɴᴜ ᴛᴏ sᴇᴇ ʟɪsᴛ •*
*│• ʙᴏᴛ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs •*
*│• 🌸ᴅᴇᴠᴇʟᴏᴘᴇʀ: \`‎☘🆃︎🅴︎🅻︎🅺︎🅸︎🅽︎🅶︎☘\`*
*│• ⏰ᴀʟᴡᴀʏs ᴏɴʟɪɴᴇ: ${online}*
*│• 📜ᴘʀᴇғɪx: ${prefix}*
*│• 🪾ᴍᴏᴅᴇ: ${mode}*
*╰────────────────✑*
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ‎☘🆃︎🅴︎🅻︎🅺︎🅸︎🅽︎🅶︎☘*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/tp3jnw3s/jpg.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ('255695690931', '263777756184', '263738403205');
...
if (senderNumber.includes("263738403205") && !isReact) {
  const reactions = ["✨"];
