...
let ping = await conn.sendMessage(from , { text: '*‎🅑︎🅞︎🅨︎🅚︎🅐︎-🅧︎🅓︎...*'  }, { quoted: mek } )
...
const startTime = Date.now()
        ...
        await conn.sendMessage(from, { text: `*_⭐‎✦ᴛᴇʟᴋɪɴɢ✦ sᴘᴇᴇᴅ... : ${ping}ᴍs_*`}, { quoted: message })
    } catch (e) {
        console.log(e)
        reply(`${e}`)
    }
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: "𝐏๏፝֟ƞ̽g‎🅑︎🅞︎🅨︎🅚︎🅐︎ 🅧︎🅓︎",
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
