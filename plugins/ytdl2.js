...
cmd({
  ...
  try {
    ...
    let _0x5eb190 = "https://apis-keith.vercel.app/download/ytmp3?url=" + encodeURIComponent(_0x5297bb.url);
...
cmd({
  ...
  try {
    ...
    let _0x33f8bb = "https://apis-keith.vercel.app/download/dlmp3?url=" + encodeURIComponent(_0x255517.url);
